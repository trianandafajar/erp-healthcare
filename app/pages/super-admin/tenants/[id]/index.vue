                    ...
                    <v-row>
                        <v-col cols="12" md="6">
                            <v-card elevation="0" variant="outlined" :style="{ borderColor: '#e0e0e0' }" class="rounded-md h-100">
                                <v-card-item>
                                    <v-card-title class="text-subtitle-1 font-weight-bold">Tenant Information</v-card-title>
                                </v-card-item>
                                <v-divider />
                                <v-card-text>
                                    <v-row dense>
                                        ...
                                        <v-col cols="6" class="mt-3">
                                            ...
                                            <v-chip size="x-small" variant="tonal" color="secondary" label>{{ tenant?.slug }}</v-chip>
                                        </v-col>
                                    </v-row>
                                </v-card-text>
                            </v-card>
                            ...
                            <v-card elevation="0" variant="outlined" :style="{ borderColor: '#e0e0e0' }" class="rounded-md h-100">
                                ...
                                <v-card-text>
                                    ...
                                    <div class="d-flex align-center justify-space-between mb-2">
                                        ...
                                        <span class="text-body-2 font-weight-bold text-success">{{ formatCurrency(tenant?.stats?.total_revenue) }}</span>
                                    </div>
                                    <div class="d-flex align-center justify-space-between">
                                        <span class="text-caption text-medium-emphasis">Pending Revenue</span>
                                        <span class="text-body-2 font-weight-medium text-warning">{{ formatCurrency(tenant?.stats?.pending_revenue) }}</span>
                                    </div>
                                </v-card-text>
                            </v-card>
                        </v-col>
                        ...
                        <v-col cols="12" md="4">
                            <v-card elevation="0" variant="outlined" :style="{ borderColor: '#e0e0e0' }" class="rounded-md h-100">
                                <v-card-item>
                                    <v-card-title class="text-subtitle-1 font-weight-bold">Appointment Breakdown</v-card-title>
                                </v-card-item>
                                <v-divider />
                                <v-card-text>
                                    <div v-for="(val, key) in tenant?.appointment_breakdown" :key="key"
                                        class="d-flex align-center justify-space-between mb-2">
                                        <v-chip :color="statusColors[key] ?? 'secondary'" variant="tonal" size="x-small" class="text-capitalize">
                        ...
                        <v-col cols="12" md="8">
                            <v-card elevation="0" variant="outlined" :style="{ borderColor: '#e0e0e0' }" class="rounded-md h-100">
                                <v-card-item>
                                    <v-card-title class="text-subtitle-1 font-weight-bold">Recent Appointments</v-card-title>
                                </v-card-item>
                                <v-divider />
                                <v-table density="comfortable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-else v-for="appt in tenant.recent_appointments" :key="appt.id">
                                            ...
                                            <td class="py-2">
                                                <v-chip :color="statusColors[appt.status] ?? 'secondary'" variant="tonal" size="x-small" class="text-capitalize">
                        ...
                        <v-col cols="12" md="7">
                            <v-card elevation="0" variant="outlined" :style="{ borderColor: '#e0e0e0' }" class="rounded-md h-100">
                                <v-card-item>
                                    ...
                                    <v-card-subtitle>How the tenant's app appears to their staff and patients</v-card-subtitle>
                                </v-card-item>
                                <v-divider />
                                <v-card-text>
                                ...
                                <v-card-text>
                                    <div class="d-flex align-center ga-4 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-caption text-medium-emphasis" style="font-family: monospace;">{{ previewColor }}</div>
                                            <v-chip v-if="previewColor === '#176D37'" size="x-small" color="grey" variant="tonal" class="mt-1">Default</v-chip>
                                        </div>
                                    </div>
                                    <div class="d-flex align-center ga-2">
                    ...
                    <v-table hover density="comfortable">
                        ...
                        <tbody>
                            ...
                            <tr v-else v-for="user in users" :key="user.id">
                                ...
                                <td class="py-2">
                                    <v-chip :color="getRoleColor(user.role)" variant="tonal" size="x-small">{{ user.role }}</v-chip>
                                </td>
                                <td class="py-2">
                    ...
                    <v-table density="comfortable">
                        ...
                        <tbody>
                            ...
                            <tr v-else v-for="log in tenant.recent_activity" :key="log.id">
                                ...
                                <td class="py-2">
                                    <v-chip size="x-small" variant="tonal" color="secondary" label>{{ log.module }}</v-chip>
                                </td>
