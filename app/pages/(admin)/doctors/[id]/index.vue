...
function genderColor(gender?: string | null) {
    if (gender === 'male' || gender === 'male') return 'info'
    if (gender === 'female' || gender === 'female') return 'pink'
    return 'secondary'
}
</script>
                    ...
                    <div class="d-flex align-center ga-4">
                        ...
                        <div>
                            ...
                            <div class="d-flex align-center ga-2 mt-1 flex-wrap">
                                ...
                                <v-chip size="small" :color="doctor.is_available ? 'success' : 'error'" variant="tonal"
                                    label>
                            ...
                            <v-col cols="12" md="6">
                                <v-card variant="outlined" height="100%">
                                    ...
                                    <v-list density="compact">
                                        <v-list-item title="Specialization" :subtitle="doctor.specialization ?? '-'" />
                                        <v-list-item title="STR Number" :subtitle="doctor.str_number ?? '-'" />
                                        <v-list-item title="SIP Number" :subtitle="doctor.sip_number ?? '-'" />
                                        <v-list-item title="Department" :subtitle="department?.name ?? '-'" />
                                        <v-list-item title="Experience"
                                            :subtitle="doctor.experience_years ? `${doctor.experience_years} years` : '-'" />
                                        <v-list-item title="Consultation Fee"
                                            :subtitle="formatCurrency(doctor.consultation_fee)" />
                                        <v-list-item title="Phone" :subtitle="doctor.phone ?? '-'" />
                                    </v-list>
                                </v-card>
                            </v-col>
                            ...
                            <v-col cols="12" md="6">
                                <v-card variant="outlined" height="100%">
                                    ...
                                    <v-list density="compact">
                                        ...
                                        <v-list-item title="Joined" :subtitle="formatDate(doctor.created_at)" />
                                        <v-list-item title="Last Updated" :subtitle="formatDate(doctor.updated_at)" />
                                    </v-list>
                                </v-card>
                            </v-col>
                                    ...
                                    <v-card-item>
                                        <template #prepend>
                                            <v-avatar color="info" variant="tonal" size="36">
                                                <v-icon icon="mdi-text-account" size="20" />
                                            </v-avatar>
                                        </template>
                                        <v-card-title class="text-body-1">Biography</v-card-title>
                                    </v-card-item>
                                    <v-divider />
                    ...
                    <v-table v-else hover density="comfortable">
                        ...
                        <tbody>
                            ...
                            <tr v-for="patient in patients" :key="patient.id">
                                ...
                                <td class="py-3">
                                    <v-chip v-if="patient.medical_record_number" size="small" color="primary"
                                        variant="tonal" label>
                                ...
                                <td class="py-3">
                                    <v-chip v-if="patient.gender" :color="genderColor(patient.gender)" size="small"
                                        variant="tonal" label>
                                        {{ patient.gender }}
                                    </v-chip>
                                    <span v-else class="text-medium-emphasis">-</span>
                                ...
                                <td class="py-3 text-right">
                                    <v-btn size="small" variant="tonal" color="primary" prepend-icon="mdi-eye-outline"
                                        @click="navigateTo(`/admin/patients/${patient.id}`)">
                                        View
                                    </v-btn>
                                </td>
                            </tr>
