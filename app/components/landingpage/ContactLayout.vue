      ...
      <div class="section row pb-0">
        <div class="col-12 md:col-6 lg:col-7">
          <form class="contact-form" method="POST" :action="contactFormAction">
            <div class="mb-3">
              <input class="w-full rounded border border-border px-4 py-3 focus:outline-none focus:border-primary" name="name" type="text" placeholder="Name" required />
            </div>
            <div class="mb-3">
              <input class="w-full rounded border border-border px-4 py-3 focus:outline-none focus:border-primary" name="email" type="email" placeholder="Your email" required />
            </div>
            <div class="mb-3">
              <input class="w-full rounded border border-border px-4 py-3 focus:outline-none focus:border-primary" name="subject" type="text" placeholder="Subject" required />
            </div>
            <div class="mb-3">
              <textarea class="w-full rounded-md border border-border px-4 py-3 focus:outline-none focus:border-primary" rows="7" placeholder="Your message" />
            </div>
