        ...
        <v-card variant="flat" class="mb-4">
          ...
          <v-card-text class="pa-5">
            <v-row>
              ...
              <v-col cols="12" sm="6">
                <v-text-field v-model="form.sip_number" label="SIP Number" variant="outlined" density="comfortable" prepend-inner-icon="mdi-card-account-details" inputmode="numeric" @keydown="e => { if (!/[0-9]/.test(e.key) && e.key !== 'Backspace' && e.key !== 'Tab' && e.key !== 'ArrowLeft' && e.key !== 'ArrowRight' && e.key !== 'Delete' && e.key !== 'End' && e.key !== 'Home') e.preventDefault() }" />
              </v-col>
              <v-col cols="12" sm="6">
              ...
              <v-col cols="12" sm="6">
                <v-text-field v-model="form.str_number" label="STR Number" variant="outlined" density="comfortable" prepend-inner-icon="mdi-shield-check" inputmode="numeric" @keydown="e => { if (!/[0-9]/.test(e.key) && e.key !== 'Backspace' && e.key !== 'Tab' && e.key !== 'ArrowLeft' && e.key !== 'ArrowRight' && e.key !== 'Delete' && e.key !== 'End' && e.key !== 'Home') e.preventDefault() }" />
              </v-col>
            </v-row>
          </v-card-text>
        </v-card>
