...
<template>
    <v-card flat class="pa-6">
        ...
        <v-table class="rounded-md" hover>
            <thead>
                <tr>
                    <th class="text-no-wrap" style="width: 40px;"></th>
                    <th class="text-no-wrap text-left font-weight-bold">Name</th>
                    <th class="text-no-wrap text-left font-weight-bold">Email</th>
                    <th class="text-no-wrap text-left font-weight-bold">Subject</th>
                    <th class="text-no-wrap text-left font-weight-bold">Date</th>
                    <th class="text-no-wrap text-center font-weight-bold">Status</th>
                    <th class="text-no-wrap text-center font-weight-bold">Actions</th>
                </tr>
            </thead>
            <tbody>
