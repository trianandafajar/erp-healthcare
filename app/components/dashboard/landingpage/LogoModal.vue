                ...
                <div class="d-flex flex-column align-center text-center ga-3">
                    ...
                    <div>
                        ...
                        <p class="text-body-2 text-medium-emphasis mt-1">
                            <strong>{{ logo?.title }}</strong> will be permanently removed.
                        </p>
                    </div>
                </div>
            </v-card-text>
            ...
            <v-card-text class="pa-4" style="max-height: 440px; overflow-y: auto;">
                <v-row dense>
                    <v-col cols="12">
                        ...
                        <v-text-field v-model="form.title" placeholder="e.g. Calendly" variant="outlined"
                            density="compact" hide-details="auto" />
                    </v-col>

                    <v-col cols="12" class="mt-3">
                        <v-label class="text-caption font-weight-medium mb-1">Logo Image</v-label>
