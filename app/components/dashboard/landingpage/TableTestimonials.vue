...
<template>
    <v-card-item class="pb-2 px-0 pt-0">
        <div class="d-flex flex-wrap align-center justify-space-between ga-3">
            <div class="min-w-0">
                <v-card-title class="text-h5 text-md-h3">Testimonial Management</v-card-title>
            ...
            <v-btn v-if="can('landingpage.testimonials.create')" color="primary" variant="flat" size="large"
                prepend-icon="mdi-plus" density="comfortable" class="flex-shrink-0" @click="openAdd">
                Add Testimonial
            </v-btn>
        </div>
    </v-card-item>
                    ...
                    <td class="py-3 ">
                        <div class="d-flex align-center gap-1">
                            <svg v-for="n in 5" :key="n"
                                class="w-4 h-4" :class="n <= testimonial.rating ? 'text-yellow-400' : 'text-gray-300'" viewBox="0 0 20 20" fill="currentColor">
                                <path
