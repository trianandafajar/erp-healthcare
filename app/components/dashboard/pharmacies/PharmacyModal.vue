...
const config = computed(() => {
    const map = {
        add: { title: 'Add Pharmacist', icon: 'mdi-account-plus', confirmColor: 'primary', confirmLabel: 'Add Pharmacist' },
        edit: { title: 'Edit Pharmacist', icon: 'mdi-account-edit', confirmColor: 'primary', confirmLabel: 'Save Changes' },
        delete: { title: 'Remove Pharmacist', icon: 'mdi-account-remove', confirmColor: 'error', confirmLabel: 'Remove' }
    }
